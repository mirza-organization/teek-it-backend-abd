            ...
            <div class="col-md-4 pl-4 pr-4 pb-4">
                <div class="card @if($user->is_active==0)
                    ...
                    <div class="card-body">
                        ...
                        <a href="/aorders?user_id={{$user->id}}" class="d-block text-right mr-3 float-right mb-3"
                            title="Orders"><i class="fas fa-clipboard-list"
                                style="font-size: 30px; color: #3a4b83;"></i></a>
                        <div class="card-text">
                            <div class="col-md-12">
