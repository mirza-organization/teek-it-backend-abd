                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="d-none col-md-3 pl- pr- pb-">
                                    <div>
                                        <h5 class="d-block text-center p-3 pb-0 m-0 text-site-primary"><a class="font-weight-bold  text-site-primary" href="#">Company Logo</a></h5>
                                    </div>
                                    <div class="card-text">
                                        <div class="col-md-12">
                                ...
                                <div class="d-none col-md-2" style="margin-top: 9%;">
                                    <div>
                                        <h5 class="d-block text-center p-3 pb-0 m-0 text-site-primary"><a class="font-weight-bold  text-site-primary" href="#">Favicon</a></h5>
                                    </div>
                                    <div class="card-text">
                                        <div class="col-md-12">
                ...
                <div class="col-md-12">
                    <div class="card  pl-4 pr-4 pb-4 p-4">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <textarea style=" border:0;margin-top: 0px;margin-bottom: 0px;height: 127px;min-height: 127px;max-height: 127px;width: 100%;min-width: 100%;max-width: 100%;background: #f4f6f9;border-radius: 15px;" placeholder="Write your terms & conditions here..." name="tos" class="form-control" onresize="return 0;">{{$terms_page->page_content}}</textarea>
                                    <button type="submit" style=" width: fit-content; margin-top: 15px!important; background: #ffcf42; border: 0; padding: 10px 60px; border-radius: 30px!important; color: black; " class="btn btn-secondary rounded mt-3 text-center align-content-center btn-block m-auto">Update</button>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-md-12">
                    <div class="card  pl-4 pr-4 pb-4 p-4">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <textarea style=" border:0;margin-top: 0px;margin-bottom: 0px;height: 127px;min-height: 127px;max-height: 127px;width: 100%;min-width: 100%;max-width: 100%;background: #f4f6f9;border-radius: 15px;" placeholder="Please write 'Frequently Asked Questions' here..." name="faq" class="form-control" onresize="return 0;">{{$faq_page->page_content}}</textarea>
                                    <button type="submit" style=" width: fit-content; margin-top: 15px!important; background: #ffcf42; border: 0; padding: 10px 60px; border-radius: 30px!important; color: black; " class="btn btn-secondary rounded mt-3 text-center align-content-center btn-block m-auto">Update</button>
                                </div>
                            </div>
                        </div>
