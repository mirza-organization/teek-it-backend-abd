...
//                                        'business_name'
                ...
                <div class="col-md-4 pl-4 pr-4 pb-4">
                    ...
                    @endif">
                        <div class="card-body">
                            <a class=" d-block text-right"  href="{{route('customer_details',['user_id'=>$user->id])}}"  pdata-toggle="modal" pdata-target="#exampleModal{{$user->id}}"  ><img class="img-size-16" src="/res/res/img/edit.png" alt=""></a>
