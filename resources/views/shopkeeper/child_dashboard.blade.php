                                    ...
                                    <div class="col-md-7">
                                        <label class=" float-right">
                                            <a href="" data-bs-toggle="modal"
                                                data-bs-target="#editUserModal{{ $user[0]->id }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <input type="text" name="business_name" id="business_name"
                                            class="form-control" value="{{ $user[0]->business_name }}">
                                ...
                                <div class="col-md-4 col-4">
                                    <div class="form-group">
                                        <input type="text" name="time[{{ $days[$i] }}][open]"
                                            id="time[{{ $days[$i] }}][open]" class="stimepicker form-control"
                                            required>
                                    </div>
                                </div>
                                <div class="col-md-4 col-4">
                                    <div class="form-group">
                                        <input type="text" name="time[{{ $days[$i] }}][close]"
                                            id="time[{{ $days[$i] }}][close]" class="etimepicker form-control"
                                            required>
                                    </div>
                                </div>
