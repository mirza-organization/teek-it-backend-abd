                                ...
                                <div class=" d-block text-right">
                                    <div class="card-text">
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <form action="{{route('add_inventory')}}" method="POST" enctype="multipart/form-data">
                                                    {{csrf_field()}}
                                                    <div class="row">
                                                        <div class="col-md-6">
                                                        ...
                                                        <div class="col-md-6 offset-md-3 text-center">
                                                            <button style="background: #ffcf42;color:black;font-weight: 600" class="pl-5 pr-5 pt-2 pb-2 border-0 btn btn-secondary rounded-pill" type="submit" >{{__('Add')}}</button>
                                                        </div>
