        ...
        <div class="container">
            ...
            <div class="col-lg-4 col-md-6 col-sm-12 pl-4 pr-4 pb-4">
                        <div class="change-height card " style="height: 317px;">
                            <div class="card-body">
                                <a href="" data-toggle="modal" data-target="#exampleModal{{$user->id}}" class=" d-block text-right float-right"><img class="img-size-16" src="/res/res/img/edit.png" alt=""></a>
                            

                                <div class="card-text">
                                    <div class="col-md-12">
                    <span class="img-container">
                    <img class="d-block m-auto" src="{{$user->category_image}}" alt="">
                    </span>
                                    </div>
                                </div>
