            ...
            <div class="row mb-2">
                <div class="col-sm-12">
                    ...
                    <a class="text-site-primary text-center m-auto d-block"
                        style="width: fit-content; font-size: 3.0em; line-height: 1;">Customers</a>
            ...
            <div class="row">
                @foreach ($users as $user)
                                                ...
                                                <label for="" class="mt-5">
                                                    ...
                                                    @else
                                                        <a
                                                            ...
                                                            <span class="text-danger">Click here to Disable Account
                                                            </span></a>
                                                    @endif
                                                </label>
                                            </div>
                    ...
                    <div class="col-md-4 pl-4 pr-4 pb-4">
                        <div
                            class="card @if ($user->is_active == 0) bg-danger
                            @else
                            bg-success @endif">
                            <div class="card-body">
                                ...
                                <a href="/aorders?user_id={{ $user->id }}"
                                    class="d-block text-right mr-3 float-right mb-3" title="Orders"><i
                                        class="fas fa-clipboard-list" style="font-size: 30px; color: #3a4b83;"></i></a>
                                <div class="card-text">
                                    <div class="col-md-12">
                                        <span class="img-container">
                                            <img class="d-block m-auto"
                                                src=@if ($user->user_img) "{{ config('constants.BUCKET') . $user->user_img }}"
                                    @else
                                ...
                                <div class="">
                                    <h3 class="d-block text-center p-3 pb-0 m-0 text-site-primary text-lg">
                                        <a href="#" class="d-block text-site-primary">{{ $user->name }}
                                            {{ $user->l_name }}</a>
                                    </h3>
                                </div>
                            </div>
