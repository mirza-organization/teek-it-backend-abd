    ...
    <div class="container-fluid">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th scope="col">
                                                            <span class="font-weight-normal">
                                                                @if($key!='application_fee' && $key!='business_hours' &&
                                                                $key!='bank_details')
                                                                {{$u}}
        ...
        <div class="row">
            ...
            <div class="col-md-12 p-4 pr-4">
                <div class="card">
                    <div class="card-body p-2 pl-5 pr-5 pb-5">
                        <div class="p-2 mb-2">Order #{{$order->id}} @if($order->order_status=='pending')<a
                                href="{{route('accept_order',['order_id'=>$order->id])}}"
                                class=" d-block float-right">Click here if Order is Ready</a>@endif</div>
