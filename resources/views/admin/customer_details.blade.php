                ...
                <div class="p-3">
                    <div class="card">
                        <div class="card-body p-2 pl-5 pr-5 pb-5">
                            <div class="row">
                                <div class="col-md-12">
                                    <div class="modal fade" id="editStoreModal{{ $user->id }}" tabindex="-1"
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group">
                                                                <label class="text-capitalize">{{ str_replace('_', ' ',
                                                                    $key) }}</label>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <span class="img-container">
                                                @if ($user->user_img)
                                                <?php $user_img = config('constants.BUCKET') . $user->user_img; ?>
                                                @else
                                                <?php $user_img = asset('/res/res/img/customer.png'); ?>
                                                @endif
                                                <img style="width: 250px;" class="d-block m-auto" src="{{ $user_img }}">
                                            </span>
                                        </div>
                                        <div class="col-md-9">
                                            <?php
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th scope="col">
                                                            <span class="font-weight-normal">
                                                                @if ($key != 'application_fee' && $key !=
                                                                'business_hours' && $key != 'bank_details')
                                                                {{ $u }}
                                                                ...
                                                                <table class="table">
                                                                    ...
                                                                    <tbody>
                                                                        ...
                                                                        @foreach ($business_hours->time as $day =>
                                                                        $time)
                                                                        <tr>
                                                                            <th scope="row">
                                                                                {{ $day }}
                                ...
                                <div class="row mb-2">
                                    ...
                                    <div class="col-md-4">
                                        <h3 class="d-block text-left p-3 pb-0 m-0 text-site-primary text-lg">
                                            <a href="#" class="d-block text-site-primary">{{
                                                $item->product->product_name }}</a>
                                            <a href="#" class="d-block text-site-primary">{{
                                                $item->product->category->category_name }}</a>
